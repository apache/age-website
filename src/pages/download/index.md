...
## Download AGE release for PostgreSQL 18.

## The current stable version and the latest release of the graph extension is 1.7.0.

<br/>

| Apache AGE Release                                                                                 | CheckSum & Signature & Verification                                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Download Apache AGE 1.7.0 ➚](https://dlcdn.apache.org/age/PG18/1.7.0/apache-age-1.7.0-src.tar.gz) | [CheckSum ➚](https://downloads.apache.org/age/PG18/1.7.0/apache-age-1.7.0-src.tar.gz.sha512) & [Signature ➚](https://downloads.apache.org/age/PG18/1.7.0/apache-age-1.7.0-src.tar.gz.asc) & [KEYS File ➚](https://downloads.apache.org/age/KEYS) & [Verify Signature ➚](https://www.apache.org/info/verification.html) |
...
## Download AGE release for PostgreSQL 17.

## The current stable version and the latest release of the graph extension is 1.6.0.

<br/>

| Apache AGE Release                                                                                 | CheckSum & Signature & Verification                                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Download Apache AGE 1.6.0 ➚](https://dlcdn.apache.org/age/PG17/1.6.0/apache-age-1.6.0-src.tar.gz) | [CheckSum ➚](https://downloads.apache.org/age/PG17/1.6.0/apache-age-1.6.0-src.tar.gz.sha512) & [Signature ➚](https://downloads.apache.org/age/PG17/1.6.0/apache-age-1.6.0-src.tar.gz.asc) & [KEYS File ➚](https://downloads.apache.org/age/KEYS) & [Verify Signature ➚](https://www.apache.org/info/verification.html) |
...
| Apache AGE Release                                                                                 | CheckSum & Signature & Verification                                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Download Apache AGE 1.6.0 ➚](https://dlcdn.apache.org/age/PG16/1.6.0/apache-age-1.6.0-src.tar.gz) | [CheckSum ➚](https://downloads.apache.org/age/PG16/1.6.0/apache-age-1.6.0-src.tar.gz.sha512) & [Signature ➚](https://downloads.apache.org/age/PG16/1.6.0/apache-age-1.6.0-src.tar.gz.asc) & [KEYS File ➚](https://downloads.apache.org/age/KEYS) & [Verify Signature ➚](https://www.apache.org/info/verification.html) |
...
| Apache AGE Release                                                                                 | CheckSum & Signature & Verification                                                                                                                                                                                                                                           |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Download Apache AGE 1.6.0 ➚](https://dlcdn.apache.org/age/PG15/1.6.0/apache-age-1.6.0-src.tar.gz) | [CheckSum ➚](https://downloads.apache.org/age/PG15/1.6.0/apache-age-1.6.0-src.tar.gz.sha512) & [Signature ➚](https://downloads.apache.org/age/PG15/1.6.0/apache-age-1.6.0-src.tar.gz.asc) & KEYS File ➚ & [Verify Signature ➚](https://www.apache.org/info/verification.html) |
